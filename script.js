...
// create function maintain the score and update the score
function storeWin(rod, score) {
 ...
 // create the function and game event 
window.addEventListener('keypress', function (event) {
    ...
    // game start event 
    if (event.code === "Enter") {
        // check the game is already on or not 
        if (!gameOn) {
            gameOn = true; 
